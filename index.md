...
<head>
  ...
  <style>
    ...
    th, td {
      border: 2px solid #828282; /* Updated border color to gray */
      text-align: center;
      padding: 8px;
      color: #828282; /* Added text color to gray */
    }
  </style>
</head>
<body>

<h2 style="color: #828282;">Contribution</h2> <!-- Optional: Updated heading color to gray -->
